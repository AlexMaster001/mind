    ...
    this.shadowRoot.innerHTML = `
      ...
      <div class="container">
        <div class="footer-content">
          ...
          <p>Вы можете быть уверены: ваши ответы только между вами и мной. Я не храню персональные данные и не передаю их никому.</p>
          ...
          <div class="copyright">
            <p>Материалы подготовлены Кирсановым Алексеем, психологом с 8-летним опытом работы с подростками и семьями.</p>
          </div>
        </div>
      </div>
    `;
